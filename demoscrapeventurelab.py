...
def scrape_brand_info(brand):
    ...
    if r.status_code == 200:
        ...
        print(brand_blurb)
        brand_info = brand_blurb + " " + brand_description
        ...
        for article in news_articles:
            ...
            if not j == 0:
                if j % 2 == 1:
                    news_articles_str = news_articles_str + article.text.strip() + "--"
                else:
                    news_articles_str = news_articles_str + article.text.strip() + ", "
            j = j +1
            print(j)
        ...
        for article in milestone_news_articles:
            ...
            if not j == 0:
                if j % 2 == 1:
                    milestone_news_list = milestone_news_list + article.text.strip() + "--"
                else:
                    milestone_news_list = milestone_news_list + article.text.strip() + ", "
            j = j+1
            print(j)
